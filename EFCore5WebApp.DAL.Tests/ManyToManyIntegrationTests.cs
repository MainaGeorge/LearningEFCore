...
{
    [TestFixture]
    public class ManyToManyIntegrationTests
    {
        ...
        public void SetUp()
        {
            _context = new AppDbContext(
                new DbContextOptionsBuilder<AppDbContext>()
                    .UseSqlServer("Server = (localdb)\\mssqllocaldb; Database = EfCoreLearningWebApp;Trusted_Connection=True;MultipleActiveResultSets=true")
                    .Options);
        ...
        {
            var son = _family.Single(x =>
                x.FirstName.Equals("David", StringComparison.CurrentCultureIgnoreCase));
            var daughter = _family.Single(x =>
                x.FirstName.Equals("Anna", StringComparison.CurrentCultureIgnoreCase));
